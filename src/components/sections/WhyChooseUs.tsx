      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start mb-16 lg:mb-20">
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-4xl lg:text-6xl font-serif leading-tight text-brand-dark mb-6 italic">
              A New Standard in <br/>
              <span className="not-italic font-light">Clinical Excellence.</span>
            </h2>
          </div>
          <p className="text-lg lg:text-xl text-slate-500 leading-relaxed font-medium lg:pt-8 text-center lg:text-left">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 border-l border-t sm:border-t-0 border-gray-100">
          {highlights.map((item, index) => (
            <motion.div
              ...
              className="p-8 lg:p-10 border-r border-b border-gray-100 group hover:bg-brand-light transition-colors"
            >
              <div className="text-brand-primary text-sm font-black uppercase tracking-[0.2em] mb-4 sm:mb-6 italic">
                {item.index} / Trust
              </div>
              <h3 className="text-xl lg:text-2xl font-serif mb-4 italic group-hover:text-brand-primary transition-colors">{item.title}</h3>
              <p className="text-slate-500 leading-relaxed text-[12px] lg:text-[13px] font-medium tracking-tight">
                {item.description}
              </p>
            </motion.div>
          ))}
